...
So all the libraries we reference here will be written to
vendor.js so they can be cached until one qof them change.
So basically, this acvoids customers having to download a
